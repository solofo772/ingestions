...
public class DataStreamJob {
    private static final String jdbcUrl = "jdbc:postgresql://192.168.43.16:543/postgres";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String topic = "Flink.public.transactions7";

        KafkaSource<Transaction> source = KafkaSource.<Transaction>builder()
                .setBootstrapServers("192.168.43.99:9092")
                .setTopics(topic)
